...
# main config
PLUGINSLUG="minimal-share-buttons"
CURRENTDIR=`pwd`
MAINFILE="minimal-share-buttons.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="https://plugins.svn.wordpress.org/minimal-share-buttons" # Remote SVN repo on wordpress.org, with no trailing slash
SVNUSER="gonzomir" # your svn username
